                      ...
                      {questions[currentQuestion].id === 3 && (
                        <div className="flex gap-3">
                          <input
                            ...
                            className="flex-1 rounded-lg border-2 border-gray-300 px-4 py-3 text-lg focus:border-main focus:outline-none transition"
                          />
                          <select
                            value={heightUnit}
                            onChange={(e) => {
                              ...
                              setUnits((prev) => ({
                                ...prev,
                                [questions[currentQuestion].id]: e.target
                                  .value as "cm" | "ft",
                              }));
                            }}
                            className="rounded-lg border-2 border-gray-300 bg-white px-4 py-3 text-lg focus:border-main focus:outline-none transition"
                          >
