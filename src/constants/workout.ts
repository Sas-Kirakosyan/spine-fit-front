...
export const secondaryButtonClass =
  "inline-flex items-center gap-2 rounded-[10px] border border-white/10 bg-[#1C2134]/80 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-200 transition hover:border-white/20 hover:bg-[#242A40] focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/40";
