      ...
      <div className="mt-10 flex-1 overflow-y-auto">
        <div className="rounded-[14px] bg-white p-6 shadow-lg backdrop-blur">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-[#0000E7]">Login</h2>
            <p className="mt-1 text-gray-900">Sign in to your account</p>
          </div>
          ...
          <form className="mt-7 space-y-5" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className={`w-full rounded-lg border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#0000E7] focus:border-transparent transition ${
